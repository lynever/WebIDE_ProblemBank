...
var main = function (args, cliArgs, configArgs) { return __awaiter(void 0, void 0, void 0, function () {
    var envPassword, password, _a, host, port, options, _b, _c, httpServer, vscode, api, update, serverAddress, openAddress;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                ...
                if (!(serverAddress && !options.socket && args.open)) return [3 /*break*/, 6];
...
function entry() {
    return __awaiter(this, void 0, void 0, function () {
        var tryParse, _a, args, cliArgs, configArgs, vscode_2;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    tryParse = function () { return __awaiter(_this, void 0, void 0, function () {
                        var cliArgs_1, configArgs_1, args_1, error_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 3, , 4]);
                                    cliArgs_1 = cli_1.parse(process.argv.slice(2));
                                    return [4 /*yield*/, cli_1.readConfigFile(cliArgs_1.config)
                                        // This prioritizes the flags set in args over the ones in the config file.
                                    ];
                                case 1:
                                    configArgs_1 = _a.sent();
                                    args_1 = Object.assign(configArgs_1, cliArgs_1);
                                    return [4 /*yield*/, cli_1.setDefaults(args_1)];
                                case 2:
                                    args_1 = _a.sent();
                                    return [2 /*return*/, [args_1, cliArgs_1, configArgs_1]];
                                case 3:
                                    error_1 = _a.sent();
                ...
                case 1:
                    _a = _b.sent(), args = _a[0], cliArgs = _a[1], configArgs = _a[2];
                    if (args.help) {
                        ...
                        wrapper_1.wrap(function () { return main(args, cliArgs, configArgs); });
                    }
                    return [2 /*return*/];
            }
        });
